...
For automatic, decidable (and thus predictable) [SMT](https://en.wikipedia.org/wiki/Satisfiability_modulo_theories) type checking.
<br>
...
{-@ safeDiv :: Int -> Int -> Int   @-}
safeDiv     :: Int -> Int -> Int  
safeDiv _ 0 = undefined -- impossible "divide-by-zero"
safeDiv x n = x `div` n
\end{code}
