...
import Prelude hiding (replicate, map, repeat, gcd, mod)
...
<p align="center">
<img src="https://imgs.xkcd.com/comics/halting_problem_2x.png
" alt="Halting Problem" style="width: 300px;" align="middle" />
</p>
...
This value (called _well founded metric_) cannot get negative!
...
| **Next:**           | [Programs are Proofs](06-reflection.html)|
